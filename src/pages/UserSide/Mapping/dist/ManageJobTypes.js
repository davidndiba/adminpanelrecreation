...
var Mapping = function () {
    ...
    var _b = react_1.useState(undefined), formValues = _b[0], setFormValues = _b[1];
    var _c = react_1.useState([]), statuses = _c[0], setStatuses = _c[1];
    // Fetch job types and statuses on component mount
    react_1.useEffect(function () {
        var fetchStatuses = function () { return __awaiter(void 0, void 0, void 0, function () {
            var response, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, umi_1.request('/statuses')];
                    case 1:
                        response = _a.sent();
                        if (Array.isArray(response.data)) {
                            setStatuses(response.data.map(function (status) { return ({
                                label: status.name,
                                value: status.id
                            }); }));
                        }
                        else {
                            antd_1.message.error('Statuses data is not in the expected format.');
                        }
                        return [3 /*break*/, 3];
                    case 2:
                        error_1 = _a.sent();
                        antd_1.message.error('Failed to fetch statuses.');
                        return [3 /*break*/, 3];
    ...
    var handleDelete = function (id) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, umi_1.request("/job-types/" + id, { method: 'DELETE' })];
                case 1:
                    _b.sent();
                    antd_1.message.success('Job Type deleted successfully.');
                    (_a = tableActionRef.current) === null || _a === void 0 ? void 0 : _a.reload();
                    return [3 /*break*/, 3];
                case 2:
                    error_2 = _b.sent();
                    antd_1.message.error('Failed to delete job type.');
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/];
            }
        });
    ...
    var columns = [
        {
            ...
            render: function (text) { return react_1["default"].createElement("strong", null, text); }
        },
        {
            title: 'Symbol',
            dataIndex: 'symbol',
        ...
        },
        {
            ...
            key: 'updated_at',
            render: function (text) { return (text ? moment_1["default"](text).format('DD-MMM-YYYY HH:mm') : 'N/A'); }
        },
        {
            title: 'Actions',
            key: 'actions',
            render: function (_, record) { return (react_1["default"].createElement(antd_1.Space, { size: "middle" },
                ...
                react_1["default"].createElement(antd_1.Tooltip, { title: "Delete" },
                    react_1["default"].createElement(antd_1.Popconfirm, { title: "Are you sure you want to delete this job type?", onConfirm: function () { return handleDelete(record.id); }, okText: "Yes", cancelText: "No" },
    ...
    return (react_1["default"].createElement("div", { style: styles.container },
        react_1["default"].createElement("div", { style: styles.heroSection },
            react_1["default"].createElement(Title, { style: styles.heroTitle }, "Job Types Management"),
        ...
        react_1["default"].createElement(pro_components_1.ProTable, { headerTitle: "Job Types List", actionRef: tableActionRef, rowKey: "id", search: false, pagination: { pageSize: 10 }, request: function (params) { return __awaiter(void 0, void 0, void 0, function () {
                var response, error_3;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, umi_1.request('/job-types', { params: params })];
                        case 1:
                            response = _a.sent();
                            return [2 /*return*/, {
            ...
            }); }, columns: columns, toolBarRender: false }),
        react_1["default"].createElement(pro_components_1.ModalForm, { title: formValues ? 'Edit Job Type' : 'Add Job Type', visible: visible, onVisibleChange: setVisible, onFinish: function (values) { return __awaiter(void 0, void 0, void 0, function () {
                var payload, error_4;
                var _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, umi_1.request("/job-types/" + formValues.id, { method: 'PUT', data: payload })];
                        case 1:
                            _b.sent();
                            antd_1.message.success('Job Type updated successfully.');
                            return [3 /*break*/, 4];
                        case 2: return [4 /*yield*/, umi_1.request('/job-types', { method: 'POST', data: payload })];
                        case 3:
                            _b.sent();
                            antd_1.message.success('Job Type added successfully.');
                            _b.label = 4;
                        case 4:
                            setVisible(false);
                            (_a = tableActionRef.current) === null || _a === void 0 ? void 0 : _a.reload();
                        ...
                        case 5:
                            error_4 = _b.sent();
                            antd_1.message.error('Failed to save job type.');
                            return [3 /*break*/, 6];
            ...
            react_1["default"].createElement(pro_components_1.ProFormText, { name: "name", label: "Job Type", placeholder: "Enter job type", rules: [{ required: true, message: 'Job Type is required.' }] }),
            react_1["default"].createElement(pro_components_1.ProFormText, { name: "symbol", label: "Symbol", placeholder: "Enter symbol", rules: [{ required: true, message: 'Symbol is required.' }] }))));
};
// Inline Styles
var styles = {
    container: {
