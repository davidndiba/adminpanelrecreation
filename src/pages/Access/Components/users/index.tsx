...
//       try {
//         await request(`${baseUrl}/users/${id}`, {
//           method: 'PUT',
//           data: {
//             display_name: values.display_name,
//             email: values.email,
...
import { request } from 'umi';
import { EditOutlined, DeleteOutlined, PlusOutlined, UserOutlined, CheckCircleOutlined, PauseCircleOutlined, ClockCircleOutlined } from '@ant-design/icons';
        ...
        <Row gutter={16} style={{ marginBottom: '16px' }}>
          ...
          <Col span={6}>
            <Card bordered>
              ...
              <div style={{ fontSize: '24px', fontWeight: 'bold' }}>{stats.activeUsers}</div>
          ...
          <Col span={6}>
            <Card bordered>
              ...
              <div style={{ fontSize: '24px', fontWeight: 'bold' }}>{stats.inactiveUsers}</div>
          ...
          <Col span={6}>
            <Card bordered>
              ...
              <div style={{ fontSize: '24px', fontWeight: 'bold' }}>{stats.pendingUsers}</div>
