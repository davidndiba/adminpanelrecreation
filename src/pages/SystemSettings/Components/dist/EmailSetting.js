...
var EmailSettings = function () {
    ...
    var emailColumns = [
        ...
        },
        {
            ...
            render: function (_, record) { return (react_1["default"].createElement(antd_1.Space, { size: "middle" },
                react_1["default"].createElement(antd_1.Button, { onClick: function () { return setEmailDetailsVisible(record.id === emailDetailsVisible ? null : record.id); } }, emailDetailsVisible === record.id ? 'Hide Details' : 'View Details'),
                react_1["default"].createElement(antd_1.Popconfirm, { title: "Are you sure you want to delete this email?", onConfirm: function () { return handleDeleteEmail(record.id); }, okText: "Yes", cancelText: "No" },
                    react_1["default"].createElement(antd_1.Button, { danger: true }, "Delete")))); }
        }
    ];
    ...
    return (react_1["default"].createElement(pro_components_1.ProCard, { title: "", bordered: true },
        react_1["default"].createElement("div", { style: { padding: '16px' } },
            react_1["default"].createElement(Title, { level: 4, style: { marginBottom: '16px' } }, "Email Settings"),
            react_1["default"].createElement("div", { style: { display: 'flex', flexDirection: 'column', gap: '16px' } },
                react_1["default"].createElement(pro_components_1.ProCard, { bordered: true },
                    react_1["default"].createElement("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center' } },
                        react_1["default"].createElement("div", null, "Email Setup"),
                        react_1["default"].createElement(antd_1.Button, { type: "primary", onClick: function () { return setIsModalVisible(true); } }, "Compose Email"))),
                react_1["default"].createElement(pro_components_1.ProCard, { bordered: true },
                    react_1["default"].createElement("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center' } },
                        react_1["default"].createElement("div", null, "Email Template"),
                        react_1["default"].createElement(antd_1.Button, { type: "primary" }, "View Template"))),
                react_1["default"].createElement(pro_components_1.ProCard, { bordered: true },
                    react_1["default"].createElement("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center' } },
                        react_1["default"].createElement("div", null, "Email Logs/Queue"),
                        react_1["default"].createElement(antd_1.Button, { type: "primary", onClick: function () { return setEmailDetailsVisible(null); } }, emailDetailsVisible ? 'Hide Logs/Queue' : 'View Logs/Queue')),
                    emailDetailsVisible === null && (react_1["default"].createElement(antd_1.Table, { columns: emailColumns, dataSource: emails, rowKey: "id", pagination: { pageSize: 10 }, style: { marginTop: '16px' } })),
                    emailDetailsVisible && emailDetails && (react_1["default"].createElement(antd_1.Collapse, { defaultActiveKey: ['1'], style: { marginTop: '16px' } },
                        react_1["default"].createElement(Panel, { header: "Details for Email ID: " + emailDetails.id, key: "1" },
                            react_1["default"].createElement("p", null,
                                react_1["default"].createElement("strong", null, "Recipient:"),
                                " ",
                            ...
                            react_1["default"].createElement("p", null,
                                react_1["default"].createElement("strong", null, "Date Sent:"),
                                " ",
                                emailDetails.dateSent),
                            react_1["default"].createElement("p", null,
                                react_1["default"].createElement("strong", null, "Body:")),
                            react_1["default"].createElement("div", null, emailDetails.body))))))),
        react_1["default"].createElement(antd_1.Modal, { title: "Compose Email", visible: isModalVisible, onCancel: function () { return setIsModalVisible(false); }, footer: null },
            react_1["default"].createElement(antd_1.Form, { layout: "vertical", onFinish: handleComposeEmail },
                react_1["default"].createElement(antd_1.Form.Item, { label: "Recipient", name: "recipient", rules: [{ required: true, message: 'Please enter the recipient email!' }] },
                ...
                react_1["default"].createElement(antd_1.Form.Item, null,
                    react_1["default"].createElement(antd_1.Button, { type: "primary", htmlType: "submit" }, "Send Email"))))));
};
