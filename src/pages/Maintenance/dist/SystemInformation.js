...
var SystemInformation = function () {
    var _a = react_1.useState(null), systemInfo = _a[0], setSystemInfo = _a[1];
    ...
    return (react_1["default"].createElement(pro_components_1.ProCard, { title: "System Information", bordered: true },
